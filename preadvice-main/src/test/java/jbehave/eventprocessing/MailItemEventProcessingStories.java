...
import jbehave.statuscalculation.MailitemStatusCalculationsTest;
...
public class MailItemEventProcessingStories extends JUnitStories{

	@Override
	public InjectableStepsFactory stepsFactory() {
		return new InstanceStepsFactory(configuration(),
				new MailitemEventProcessingTest());
	}
